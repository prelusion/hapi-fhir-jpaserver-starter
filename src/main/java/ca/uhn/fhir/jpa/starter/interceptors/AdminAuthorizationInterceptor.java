...
public class AdminAuthorizationInterceptor extends AuthorizationInterceptor {

	@Override
	public List<IAuthRule> buildRuleList(RequestDetails theRequestDetails) {

		System.out.println(">>> getParameters \n");
		System.out.print(theRequestDetails.getParameters());
		System.out.println(">>> getServer \n");
		System.out.print(theRequestDetails.getServer());
		System.out.println(">>> getFhirServerBase \n");
		System.out.print(theRequestDetails.getFhirServerBase());
		System.out.println(">>> getHeader \n");
		System.out.print(theRequestDetails.getHeader("Authorization"));
		System.out.println(">>> getOperation \n");
		System.out.print(theRequestDetails.getOperation());
		System.out.println(">>> getRequestId \n");
		System.out.print(theRequestDetails.getRequestId());
		System.out.println(">>> getRequestPath \n");
		System.out.print(theRequestDetails.getRequestPath());
		System.out.println(">>> getResourceName \n");
		System.out.print(theRequestDetails.getResourceName());
		System.out.println(">>> getFhirContext \n");
		System.out.print(theRequestDetails.getFhirContext());
		System.out.println(">>> getCompleteUrl \n");
		System.out.print(theRequestDetails.getCompleteUrl());
